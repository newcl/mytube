...
#if TARGET_OS_IOS
  // Mytube is a background-media app. Leaving this on AVPlayer's automatic
  // policy lets iOS decide to pause audiovisual playback when the scene moves
  // to the background. Make the app's intent explicit; the audio background
  // mode and playback audio session still determine whether continuation is
  // actually permitted.
